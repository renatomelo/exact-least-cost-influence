...
)
{
   ...
   *result = SCIP_DIDNOTFIND;
   ...
   try
   {
      ...
      model.addConstr(lhs, GRB_GREATER_EQUAL, 2, "size-of-X cons");
      ...
      for (DNodeIt v(instance.g); v != INVALID; ++v)
         lhs2 += isOnRHS[v];
      lhs2 += lifting;
      model.addConstr(lhs2, GRB_EQUAL, 1, "decide-lifting cons");
      ...
      for (DNodeIt v(instance.g); v != INVALID; ++v)
      {
         ...
         model.addConstr(lhs3, GRB_LESS_EQUAL, 0, "node-in-rhs cons");
      }
